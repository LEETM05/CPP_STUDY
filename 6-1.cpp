...
class Employee {
   ...
   public:
    ...
    void print_info() { cout << name << " (" << position << " , " << age << ") ==> " << calculate_pay() << "만원\n"; }
...
class Manager : public Employee {
   ...
   public:
    ...
    void print_info() { cout << name << " (" << position << " , " << age << " , " << year_of_service << "년차 ) ==> " << calculate_pay() << "만원\n"; }
};
